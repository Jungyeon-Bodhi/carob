...
class Indicator:
    ...
    def __init__(self, df, name, number, var, i_cal, i_type, description, period, target, chi = None):
        """
        ...
        chi: bool, Option for chi2 test (True)
        """
        self.df = df
        self.name = name
        self.number = number
    ...
    def add_kap_label(self, labels):
        """
        - Add the condition for column label change (for KAP)
        labels: list, New column labels
        """
